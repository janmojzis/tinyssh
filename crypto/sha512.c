...
static crypto_uint64 load64_bigendian(const unsigned char *x) {
...
static crypto_uint64 R(crypto_uint64 x,int c) { return (x >> c) | ((x & 0xffffffffffffffffULL) << (64 - c)); }
...
static void blocks(crypto_uint64 *z, const unsigned char *m, unsigned long long n) {
...
void sha512_hash(unsigned char *o, const unsigned char *m, unsigned long long n, crypto_uint64 *h) {
