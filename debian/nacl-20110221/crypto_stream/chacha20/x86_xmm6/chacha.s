...
# qhasm: enter ECRYPT_chacha20_x86_xmm6_keystream_bytes
.text
.p2align 5
.globl _ECRYPT_chacha20_x86_xmm6_keystream_bytes
.globl ECRYPT_chacha20_x86_xmm6_keystream_bytes
_ECRYPT_chacha20_x86_xmm6_keystream_bytes:
ECRYPT_chacha20_x86_xmm6_keystream_bytes:
mov %esp,%eax
and $31,%eax
add $608,%eax
sub %eax,%esp
...
# qhasm: enter ECRYPT_chacha20_x86_xmm6_dECRYPT_chacha20_x86_xmm6_bytes
.text
.p2align 5
.globl _ECRYPT_chacha20_x86_xmm6_dECRYPT_chacha20_x86_xmm6_bytes
.globl ECRYPT_chacha20_x86_xmm6_dECRYPT_chacha20_x86_xmm6_bytes
_ECRYPT_chacha20_x86_xmm6_dECRYPT_chacha20_x86_xmm6_bytes:
ECRYPT_chacha20_x86_xmm6_dECRYPT_chacha20_x86_xmm6_bytes:
mov %esp,%eax
and $31,%eax
add $608,%eax
sub %eax,%esp
...
# qhasm: enter ECRYPT_chacha20_x86_xmm6_encrypt_bytes
.text
.p2align 5
.globl _ECRYPT_chacha20_x86_xmm6_encrypt_bytes
.globl ECRYPT_chacha20_x86_xmm6_encrypt_bytes
_ECRYPT_chacha20_x86_xmm6_encrypt_bytes:
ECRYPT_chacha20_x86_xmm6_encrypt_bytes:
mov %esp,%eax
and $31,%eax
add $608,%eax
sub %eax,%esp
...
# asm 1: psrld $16,<u=int6464#5
# asm 2: psrld $16,<u=%xmm4
psrld $16,%xmm4

# qhasm: 		t ^= u
# asm 1: pxor  <u=int6464#5,<t=int6464#3
# asm 2: pxor  <u=%xmm4,<t=%xmm2
pxor  %xmm4,%xmm2
...
# qhasm: 		u = q
# asm 1: movdqa <q=int6464#4,>u=int6464#5
# asm 2: movdqa <q=%xmm3,>u=%xmm4
movdqa %xmm3,%xmm4
...
# asm 1: psrld $20,<u=int6464#5
# asm 2: psrld $20,<u=%xmm4
psrld $20,%xmm4
...
# qhasm:                   		mp = z1_stack
# asm 1: movdqa <z1_stack=stack128#24,>mp=int6464#1
# asm 2: movdqa <z1_stack=400(%esp),>mp=%xmm0
movdqa 400(%esp),%xmm0

# qhasm:                   		mq = z5_stack
# asm 1: movdqa <z5_stack=stack128#17,>mq=int6464#5
# asm 2: movdqa <z5_stack=288(%esp),>mq=%xmm4
movdqa 288(%esp),%xmm4

# qhasm:                   		mt = z13_stack
# asm 1: movdqa <z13_stack=stack128#26,>mt=int6464#6
# asm 2: movdqa <z13_stack=432(%esp),>mt=%xmm5
movdqa 432(%esp),%xmm5

# qhasm:                   		mr = z9_stack
# asm 1: movdqa <z9_stack=stack128#28,>mr=int6464#7
# asm 2: movdqa <z9_stack=464(%esp),>mr=%xmm6
movdqa 464(%esp),%xmm6

# qhasm: uint32323232	  		mp += mq
# asm 1: paddd <mq=int6464#5,<mp=int6464#1
# asm 2: paddd <mq=%xmm4,<mp=%xmm0
paddd %xmm4,%xmm0

# qhasm: 		  		mt ^= mp
# asm 1: pxor  <mp=int6464#1,<mt=int6464#6
# asm 2: pxor  <mp=%xmm0,<mt=%xmm5
pxor  %xmm0,%xmm5

# qhasm: 		  		mu = mt
# asm 1: movdqa <mt=int6464#6,>mu=int6464#8
# asm 2: movdqa <mt=%xmm5,>mu=%xmm7
movdqa %xmm5,%xmm7

# qhasm: uint32323232	  		mt <<= 16
# asm 1: pslld $16,<mt=int6464#6
# asm 2: pslld $16,<mt=%xmm5
pslld $16,%xmm5

# qhasm: uint32323232	  		mu >>= 16
# asm 1: psrld $16,<mu=int6464#8
# asm 2: psrld $16,<mu=%xmm7
psrld $16,%xmm7

# qhasm: 		  		mt ^= mu
# asm 1: pxor  <mu=int6464#8,<mt=int6464#6
# asm 2: pxor  <mu=%xmm7,<mt=%xmm5
pxor  %xmm7,%xmm5

# qhasm: uint32323232	  		mr += mt
# asm 1: paddd <mt=int6464#6,<mr=int6464#7
# asm 2: paddd <mt=%xmm5,<mr=%xmm6
paddd %xmm5,%xmm6

# qhasm: 		  		mq ^= mr
# asm 1: pxor  <mr=int6464#7,<mq=int6464#5
# asm 2: pxor  <mr=%xmm6,<mq=%xmm4
pxor  %xmm6,%xmm4

# qhasm: 		  		mu = mq
# asm 1: movdqa <mq=int6464#5,>mu=int6464#8
# asm 2: movdqa <mq=%xmm4,>mu=%xmm7
movdqa %xmm4,%xmm7

# qhasm: uint32323232	  		mq <<= 12
# asm 1: pslld $12,<mq=int6464#5
# asm 2: pslld $12,<mq=%xmm4
pslld $12,%xmm4

# qhasm: uint32323232	  		mu >>= 20
# asm 1: psrld $20,<mu=int6464#8
# asm 2: psrld $20,<mu=%xmm7
psrld $20,%xmm7

# qhasm: 		  		mq ^= mu
# asm 1: pxor  <mu=int6464#8,<mq=int6464#5
# asm 2: pxor  <mu=%xmm7,<mq=%xmm4
pxor  %xmm7,%xmm4
...
# qhasm: 		  		z1_stack = mp
# asm 1: movdqa <mp=int6464#1,>z1_stack=stack128#17
# asm 2: movdqa <mp=%xmm0,>z1_stack=288(%esp)
movdqa %xmm0,288(%esp)
...
# qhasm: 		  		mu = mt
# asm 1: movdqa <mt=int6464#6,>mu=int6464#1
# asm 2: movdqa <mt=%xmm5,>mu=%xmm0
movdqa %xmm5,%xmm0

# qhasm: uint32323232	  		mt <<= 8
# asm 1: pslld $8,<mt=int6464#6
# asm 2: pslld $8,<mt=%xmm5
pslld $8,%xmm5

# qhasm: uint32323232	  		mu >>= 24
# asm 1: psrld $24,<mu=int6464#1
# asm 2: psrld $24,<mu=%xmm0
psrld $24,%xmm0

# qhasm: 		  		mt ^= mu
# asm 1: pxor  <mu=int6464#1,<mt=int6464#6
# asm 2: pxor  <mu=%xmm0,<mt=%xmm5
pxor  %xmm0,%xmm5

# qhasm: 		  		z13_stack = mt
# asm 1: movdqa <mt=int6464#6,>z13_stack=stack128#30
# asm 2: movdqa <mt=%xmm5,>z13_stack=496(%esp)
movdqa %xmm5,496(%esp)
...
# qhasm: 		  		z9_stack = mr
# asm 1: movdqa <mr=int6464#7,>z9_stack=stack128#31
# asm 2: movdqa <mr=%xmm6,>z9_stack=512(%esp)
movdqa %xmm6,512(%esp)
...
# qhasm: 		  		mu = mq
# asm 1: movdqa <mq=int6464#5,>mu=int6464#1
# asm 2: movdqa <mq=%xmm4,>mu=%xmm0
movdqa %xmm4,%xmm0

# qhasm: uint32323232	  		mq <<= 7
# asm 1: pslld $7,<mq=int6464#5
# asm 2: pslld $7,<mq=%xmm4
pslld $7,%xmm4

# qhasm: uint32323232	  		mu >>= 25
# asm 1: psrld $25,<mu=int6464#1
# asm 2: psrld $25,<mu=%xmm0
psrld $25,%xmm0

# qhasm: 		  		mq ^= mu
# asm 1: pxor  <mu=int6464#1,<mq=int6464#5
# asm 2: pxor  <mu=%xmm0,<mq=%xmm4
pxor  %xmm0,%xmm4

# qhasm: 		  		z5_stack = mq
# asm 1: movdqa <mq=int6464#5,>z5_stack=stack128#32
# asm 2: movdqa <mq=%xmm4,>z5_stack=528(%esp)
movdqa %xmm4,528(%esp)
...
# qhasm: 						z2_stack = p
# asm 1: movdqa <p=int6464#1,>z2_stack=stack128#20
# asm 2: movdqa <p=%xmm0,>z2_stack=336(%esp)
movdqa %xmm0,336(%esp)
...
# qhasm:                   						mp = z3_stack
# asm 1: movdqa <z3_stack=stack128#21,>mp=int6464#1
# asm 2: movdqa <z3_stack=352(%esp),>mp=%xmm0
movdqa 352(%esp),%xmm0

# qhasm:                   						mq = z7_stack
# asm 1: movdqa <z7_stack=stack128#25,>mq=int6464#5
# asm 2: movdqa <z7_stack=416(%esp),>mq=%xmm4
movdqa 416(%esp),%xmm4

# qhasm:                   						mt = z15_stack
# asm 1: movdqa <z15_stack=stack128#19,>mt=int6464#6
# asm 2: movdqa <z15_stack=320(%esp),>mt=%xmm5
movdqa 320(%esp),%xmm5

# qhasm:                   						mr = z11_stack
# asm 1: movdqa <z11_stack=stack128#23,>mr=int6464#7
# asm 2: movdqa <z11_stack=384(%esp),>mr=%xmm6
movdqa 384(%esp),%xmm6
...
# qhasm: 		  						z3_stack = mp
# asm 1: movdqa <mp=int6464#1,>z3_stack=stack128#21
# asm 2: movdqa <mp=%xmm0,>z3_stack=352(%esp)
movdqa %xmm0,352(%esp)
...
# qhasm: 						z6_stack = q
# asm 1: movdqa <q=int6464#4,>z6_stack=stack128#18
# asm 2: movdqa <q=%xmm3,>z6_stack=304(%esp)
movdqa %xmm3,304(%esp)
...
# qhasm: 		  						z11_stack = mr
# asm 1: movdqa <mr=int6464#7,>z11_stack=stack128#19
# asm 2: movdqa <mr=%xmm6,>z11_stack=320(%esp)
movdqa %xmm6,320(%esp)
...
# qhasm: 		  						z7_stack = mq
# asm 1: movdqa <mq=int6464#5,>z7_stack=stack128#27
# asm 2: movdqa <mq=%xmm4,>z7_stack=448(%esp)
movdqa %xmm4,448(%esp)
...
# qhasm:                 q = z5_stack
# asm 1: movdqa <z5_stack=stack128#32,>q=int6464#4
# asm 2: movdqa <z5_stack=528(%esp),>q=%xmm3
movdqa 528(%esp),%xmm3

# qhasm:                 t = mt
# asm 1: movdqa <mt=int6464#6,>t=int6464#3
# asm 2: movdqa <mt=%xmm5,>t=%xmm2
movdqa %xmm5,%xmm2
...
# qhasm:                   		mp = z1_stack
# asm 1: movdqa <z1_stack=stack128#17,>mp=int6464#1
# asm 2: movdqa <z1_stack=288(%esp),>mp=%xmm0
movdqa 288(%esp),%xmm0

# qhasm:                   		mq = z6_stack
# asm 1: movdqa <z6_stack=stack128#18,>mq=int6464#5
# asm 2: movdqa <z6_stack=304(%esp),>mq=%xmm4
movdqa 304(%esp),%xmm4

# qhasm:                   		mt = z12_stack
# asm 1: movdqa <z12_stack=stack128#24,>mt=int6464#6
# asm 2: movdqa <z12_stack=400(%esp),>mt=%xmm5
movdqa 400(%esp),%xmm5

# qhasm:                   		mr = z11_stack
# asm 1: movdqa <z11_stack=stack128#19,>mr=int6464#7
# asm 2: movdqa <z11_stack=320(%esp),>mr=%xmm6
movdqa 320(%esp),%xmm6
...
# qhasm: 		  		z1_stack = mp
# asm 1: movdqa <mp=int6464#1,>z1_stack=stack128#24
# asm 2: movdqa <mp=%xmm0,>z1_stack=400(%esp)
movdqa %xmm0,400(%esp)
...
# qhasm: 		  		z12_stack = mt
# asm 1: movdqa <mt=int6464#6,>z12_stack=stack128#32
# asm 2: movdqa <mt=%xmm5,>z12_stack=528(%esp)
movdqa %xmm5,528(%esp)
...
# qhasm: 		  		z11_stack = mr
# asm 1: movdqa <mr=int6464#7,>z11_stack=stack128#23
# asm 2: movdqa <mr=%xmm6,>z11_stack=384(%esp)
movdqa %xmm6,384(%esp)
...
# qhasm: 		  		z6_stack = mq
# asm 1: movdqa <mq=int6464#5,>z6_stack=stack128#22
# asm 2: movdqa <mq=%xmm4,>z6_stack=368(%esp)
movdqa %xmm4,368(%esp)

# qhasm:                 				p = z2_stack
# asm 1: movdqa <z2_stack=stack128#20,>p=int6464#1
# asm 2: movdqa <z2_stack=336(%esp),>p=%xmm0
movdqa 336(%esp),%xmm0

# qhasm:                 				q = z7_stack
# asm 1: movdqa <z7_stack=stack128#27,>q=int6464#4
# asm 2: movdqa <z7_stack=448(%esp),>q=%xmm3
movdqa 448(%esp),%xmm3
...
# qhasm:                 				t = z13_stack
# asm 1: movdqa <z13_stack=stack128#30,>t=int6464#3
# asm 2: movdqa <z13_stack=496(%esp),>t=%xmm2
movdqa 496(%esp),%xmm2
...
# qhasm:                   						mq = z4_stack
# asm 1: movdqa <z4_stack=stack128#28,>mq=int6464#5
# asm 2: movdqa <z4_stack=464(%esp),>mq=%xmm4
movdqa 464(%esp),%xmm4

# qhasm:                   						mt = z14_stack
# asm 1: movdqa <z14_stack=stack128#25,>mt=int6464#6
# asm 2: movdqa <z14_stack=416(%esp),>mt=%xmm5
movdqa 416(%esp),%xmm5

# qhasm:                   						mr = z9_stack
# asm 1: movdqa <z9_stack=stack128#31,>mr=int6464#7
# asm 2: movdqa <z9_stack=512(%esp),>mr=%xmm6
movdqa 512(%esp),%xmm6
...
# qhasm: 		  						z14_stack = mt
# asm 1: movdqa <mt=int6464#6,>z14_stack=stack128#20
# asm 2: movdqa <mt=%xmm5,>z14_stack=336(%esp)
movdqa %xmm5,336(%esp)
...
# qhasm: 		  						z9_stack = mr
# asm 1: movdqa <mr=int6464#7,>z9_stack=stack128#28
# asm 2: movdqa <mr=%xmm6,>z9_stack=464(%esp)
movdqa %xmm6,464(%esp)
...
# qhasm:                 q = mq
# asm 1: movdqa <mq=int6464#5,>q=int6464#4
# asm 2: movdqa <mq=%xmm4,>q=%xmm3
movdqa %xmm4,%xmm3
...
# qhasm:   z4_stack = q
# asm 1: movdqa <q=int6464#4,>z4_stack=stack128#30
# asm 2: movdqa <q=%xmm3,>z4_stack=496(%esp)
movdqa %xmm3,496(%esp)

# qhasm:   z8_stack = r
# asm 1: movdqa <r=int6464#2,>z8_stack=stack128#31
# asm 2: movdqa <r=%xmm1,>z8_stack=512(%esp)
movdqa %xmm1,512(%esp)
...
# qhasm:   z8 = z8_stack
# asm 1: movdqa <z8_stack=stack128#31,>z8=int6464#1
# asm 2: movdqa <z8_stack=512(%esp),>z8=%xmm0
movdqa 512(%esp),%xmm0
...
# asm 2: leal <tmp=544(%esp),>out=%edi
leal 544(%esp),%edi
...
# qhasm: enter ECRYPT_chacha20_x86_xmm6_init
.text
.p2align 5
.globl _ECRYPT_chacha20_x86_xmm6_init
.globl ECRYPT_chacha20_x86_xmm6_init
_ECRYPT_chacha20_x86_xmm6_init:
ECRYPT_chacha20_x86_xmm6_init:
mov %esp,%eax
and $31,%eax
add $608,%eax
sub %eax,%esp
...
# qhasm: enter ECRYPT_chacha20_x86_xmm6_keysetup
.text
.p2align 5
.globl _ECRYPT_chacha20_x86_xmm6_keysetup
.globl ECRYPT_chacha20_x86_xmm6_keysetup
_ECRYPT_chacha20_x86_xmm6_keysetup:
ECRYPT_chacha20_x86_xmm6_keysetup:
mov %esp,%eax
and $31,%eax
add $608,%eax
sub %eax,%esp
...
# qhasm: enter ECRYPT_chacha20_x86_xmm6_ivsetup
.text
.p2align 5
.globl _ECRYPT_chacha20_x86_xmm6_ivsetup
.globl ECRYPT_chacha20_x86_xmm6_ivsetup
_ECRYPT_chacha20_x86_xmm6_ivsetup:
ECRYPT_chacha20_x86_xmm6_ivsetup:
mov %esp,%eax
and $31,%eax
add $608,%eax
sub %eax,%esp
